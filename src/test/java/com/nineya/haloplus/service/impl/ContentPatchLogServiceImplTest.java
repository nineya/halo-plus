...
import com.nineya.haloplus.repository.ContentPatchLogRepository;
import com.nineya.haloplus.repository.ContentRepository;
...
public class ContentPatchLogServiceImplTest {
    ...
    public void createOrUpdate() {
        ...
        Assertions.assertThat(created.getStatus()).isEqualTo(PostStatus.DRAFT);
    ...
    public void applyPatch() {
        ...
        Content.PatchedContent patchedContent =
    ...
    public void generateDiff() {
        Content.ContentDiff contentDiff =
    ...
    public void getPatchedContentById() {
        Content.PatchedContent patchedContent = contentPatchLogService.getPatchedContentById(2);
