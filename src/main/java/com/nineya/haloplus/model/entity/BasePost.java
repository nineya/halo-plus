...
public class BasePost extends BaseEntity {
    ...
    @GenericGenerator(name = "custom-id", strategy = "com.nineya.haloplus.model.entity.support"
        + ".CustomIdGenerator")
    private Integer id;
     ...
     * Gets post content.
     *
     * @return a {@link Content.PatchedContent} if present,otherwise an empty object
     */
    @NonNull
