package com.nineya.haloplus.cache.lock;
...
import com.nineya.haloplus.exception.FrequentAccessException;
...
public class CacheLockInterceptor {
    ...
    @Around("@annotation(com.nineya.haloplus.cache.lock.CacheLock)")
