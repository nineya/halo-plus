...
import com.nineya.haloplus.model.support.Pagination;
import com.nineya.haloplus.model.support.RainbowPage;
        ...
        if (params.containsKey(HaloConst.METHOD_KEY)) {
            ...
            switch (method) {
                case "index":
                    ...
                    if (page == 1) {
                        prevPageFullPath.append(HaloConst.URL_SEPARATOR);
                    } else {
                ...
                case "archives":
                    ...
                    nextPageFullPath.append(HaloConst.URL_SEPARATOR)
